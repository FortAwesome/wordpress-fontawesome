...
/******/ 		return __webpack_require__.p + "" + ({"vendors~polyfills-core-js":"vendors~polyfills-core-js","vendors~polyfills-css-shim":"vendors~polyfills-css-shim","vendors~polyfills-dom":"vendors~polyfills-dom"}[chunkId]||chunkId) + ".js"
/******/ 	}
/******/
...
/******/ 		var cssChunks = {"4":1,"6":1,"10":1};
/******/ 		if(installedCssChunks[chunkId]) promises.push(installedCssChunks[chunkId]);
/******/ 		else if(installedCssChunks[chunkId] !== 0 && cssChunks[chunkId]) {
/******/ 			promises.push(installedCssChunks[chunkId] = new Promise(function(resolve, reject) {
/******/ 				var href = "" + ({"vendors~polyfills-core-js":"vendors~polyfills-core-js","vendors~polyfills-css-shim":"vendors~polyfills-css-shim","vendors~polyfills-dom":"vendors~polyfills-dom"}[chunkId]||chunkId) + ".css";
...
/******/
/******/ 	var jsonpArray = window["webpackJsonp_font_awesome_admin"] = window["webpackJsonp_font_awesome_admin"] || [];
...
__webpack_require__.p = lodash_get__WEBPACK_IMPORTED_MODULE_1___default()(initialData, 'webpackPublicPath');
...
if (lodash_get__WEBPACK_IMPORTED_MODULE_1___default()(initialData, 'showConflictDetectionReporter')) {
  const reportEvent = new Event(CONFLICT_DETECTION_REPORT_EVENT_TYPE, {
    "bubbles": true,
    "cancelable": false
  });
  /**
...
if (!window.__Font_Awesome_Webpack_Externals__) {
  window.__Font_Awesome_Webpack_Externals__ = {
    React: lodash_get__WEBPACK_IMPORTED_MODULE_1___default()(window, 'React'),
    ReactDOM: lodash_get__WEBPACK_IMPORTED_MODULE_1___default()(window, 'ReactDOM'),
    i18n: lodash_get__WEBPACK_IMPORTED_MODULE_1___default()(window, 'wp.i18n'),
    apiFetch: lodash_get__WEBPACK_IMPORTED_MODULE_1___default()(window, 'wp.apiFetch'),
    components: lodash_get__WEBPACK_IMPORTED_MODULE_1___default()(window, 'wp.components'),
    element: lodash_get__WEBPACK_IMPORTED_MODULE_1___default()(window, 'wp.element'),
    richText: lodash_get__WEBPACK_IMPORTED_MODULE_1___default()(window, 'wp.richText'),
    blockEditor: lodash_get__WEBPACK_IMPORTED_MODULE_1___default()(window, 'wp.blockEditor'),
    domReady: lodash_get__WEBPACK_IMPORTED_MODULE_1___default()(window, 'wp.domReady')
  };
}

const {
  __
} = __Font_Awesome_Webpack_Externals__.i18n;

if (!initialData) {
  console.error(__('Font Awesome plugin is broken: initial state data missing.', 'font-awesome'));
}

const store = Object(_store__WEBPACK_IMPORTED_MODULE_0__["createStore"])(initialData);
const {
  showAdmin,
...
if (showAdmin) {
  Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(1), __webpack_require__.e(2), __webpack_require__.e(5), __webpack_require__.e(4)]).then(__webpack_require__.bind(null, /*! ./mountAdminView */ "./src/mountAdminView.js")).then(({
    default: mountAdminView
  }) => {
...
if (showConflictDetectionReporter) {
  Promise.all([Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(1), __webpack_require__.e(9)]).then(__webpack_require__.bind(null, /*! ./store/actions */ "./src/store/actions.js")), Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(1), __webpack_require__.e(2), __webpack_require__.e(6)]).then(__webpack_require__.bind(null, /*! ./mountConflictDetectionReporter */ "./src/mountConflictDetectionReporter.js"))]).then(([{
    reportDetectedConflicts
  }, {
...
if (enableIconChooser) {
  if (usingCompatJs && isGutenbergPage) {
    ...
    Promise.all([Promise.all(/*! import() */[__webpack_require__.e(7), __webpack_require__.e(8)]).then(__webpack_require__.bind(null, /*! ./chooser */ "./src/chooser/index.js")), __webpack_require__.e(/*! import() */ 15).then(__webpack_require__.bind(null, /*! ./chooser/handleQuery */ "./src/chooser/handleQuery.js")), Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(14)]).then(__webpack_require__.bind(null, /*! ./chooser/getUrlText */ "./src/chooser/getUrlText.js"))]).then(([{
      setupIconChooser
    }, {
      default: configureQueryHandler
    }, {
      default: getUrlText
    }]) => {
      ...
      const params = { ...initialData,
        ...
        version,
        getUrlText,
        pro: lodash_get__WEBPACK_IMPORTED_MODULE_1___default()(initialData, 'options.usePro')
      };
      const handleQuery = configureQueryHandler(params);
      const {
        setupClassicEditorIconChooser
      } = setupIconChooser({ ...params,
        handleQuery
      });
      /**
...
const composeEnhancers =  true && window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ || redux__WEBPACK_IMPORTED_MODULE_0__["compose"];
const enhancer = composeEnhancers(Object(redux__WEBPACK_IMPORTED_MODULE_0__["applyMiddleware"])(...middleware));
function createStore(initialData = {}) {
  return Object(redux__WEBPACK_IMPORTED_MODULE_0__["createStore"])(_reducers__WEBPACK_IMPORTED_MODULE_2__["default"], initialData, enhancer);
}
...
/*!*************************************!*\
  !*** ./src/store/reducers/index.js ***!
  \*************************************/
/*! exports provided: ADMIN_TAB_SETTINGS, ADMIN_TAB_TROUBLESHOOT, blocklistSelector, options, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ADMIN_TAB_SETTINGS", function() { return ADMIN_TAB_SETTINGS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ADMIN_TAB_TROUBLESHOOT", function() { return ADMIN_TAB_TROUBLESHOOT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "blocklistSelector", function() { return blocklistSelector; });
...
const ADMIN_TAB_SETTINGS = 'ADMIN_TAB_SETTINGS';
const ADMIN_TAB_TROUBLESHOOT = 'ADMIN_TAB_TROUBLESHOOT';

const coerceBool = val => val === true || val === "1";

const coerceEmptyArrayToEmptyObject = val => lodash_size__WEBPACK_IMPORTED_MODULE_0___default()(val) === 0 ? {} : val; // TODO: add reducer for the clientPreferences that coerces their boolean options


function blocklistSelector(state = {}) {
  const unregisteredClients = state.unregisteredClients || {};
  return Object.keys(unregisteredClients).reduce((acc, md5) => {
    if (lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(unregisteredClients, [md5, 'blocked'], false)) {
      acc.push(md5);
    }
...
function options(state = {}, action = {}) {
  ...
  switch (type) {
    case 'OPTIONS_FORM_SUBMIT_END':
      if (!lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(action, 'data.options')) {
        return state;
      } else {
        const {
          options: {
...
function pendingOptions(state = {}, action = {}) {
  ...
  switch (type) {
    ...
    case 'RESET_PENDING_OPTION':
      ...
      return lodash_omit__WEBPACK_IMPORTED_MODULE_1___default()(state, option);

    case 'CHOOSE_AWAY_FROM_KIT_CONFIG':
      return !!activeKitToken ? {
        kitToken: null,
...
function preferenceConflicts(state = {}, action = {}) {
  ...
  switch (type) {
    case 'OPTIONS_FORM_SUBMIT_END':
      ...
      const conflicts = lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(action, 'data.conflicts');
...
function preferenceConflictDetection(state = {
  isChecking: false,
  hasChecked: false,
  success: false,
  message: ''
...
function kitsQueryStatus(state = {
  success: false,
  hasSubmitted: false,
  isSubmitting: false,
  message: ''
...
function kits(state = [], action = {}) {
  ...
  switch (type) {
    case 'KITS_QUERY_END':
      if (success) {
        return lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(data, 'me.kits', []);
      } else {
        return state;
      }
...
function detectConflictsUntil(state = 0, action = {}) {
  ...
  const intValue = parseInt(lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(data, 'detectConflictsUntil'));
  ...
  switch (type) {
    ...
    case 'BLOCKLIST_UPDATE_END':
      if (action.success && Array.isArray(data)) {
        const updatedState = Object.keys(state).reduce((acc, md5) => {
...
function unregisteredClientDetectionStatus(state = {
  success: false,
  hasSubmitted: false,
  isSubmitting: false,
...
function conflictDetectionScannerStatus(state = {
  isSubmitting: false,
  hasSubmitted: false,
  success: false,
  message: ''
...
function v3DeprecationWarningStatus(state = {
  isSubmitting: false,
  hasSubmitted: false,
  success: false,
  message: ''
...
/***/ "@wordpress/api-fetch":
/*!**************************************************************!*\
  !*** external "__Font_Awesome_Webpack_Externals__.apiFetch" ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = __Font_Awesome_Webpack_Externals__.apiFetch;

/***/ }),

/***/ "@wordpress/block-editor":
/*!*****************************************************************!*\
  !*** external "__Font_Awesome_Webpack_Externals__.blockEditor" ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = __Font_Awesome_Webpack_Externals__.blockEditor;

/***/ }),

/***/ "@wordpress/components":
/*!****************************************************************!*\
  !*** external "__Font_Awesome_Webpack_Externals__.components" ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = __Font_Awesome_Webpack_Externals__.components;

/***/ }),

/***/ "@wordpress/dom-ready":
/*!**************************************************************!*\
  !*** external "__Font_Awesome_Webpack_Externals__.domReady" ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = __Font_Awesome_Webpack_Externals__.domReady;

/***/ }),

/***/ "@wordpress/element":
/*!*************************************************************!*\
  !*** external "__Font_Awesome_Webpack_Externals__.element" ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = __Font_Awesome_Webpack_Externals__.element;

/***/ }),

/***/ "@wordpress/i18n":
/*!**********************************************************!*\
  !*** external "__Font_Awesome_Webpack_Externals__.i18n" ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = __Font_Awesome_Webpack_Externals__.i18n;

/***/ }),

/***/ "@wordpress/rich-text":
/*!**************************************************************!*\
  !*** external "__Font_Awesome_Webpack_Externals__.richText" ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = __Font_Awesome_Webpack_Externals__.richText;

/***/ }),

/***/ "react":
/*!***********************************************************!*\
  !*** external "__Font_Awesome_Webpack_Externals__.React" ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = __Font_Awesome_Webpack_Externals__.React;

/***/ }),

/***/ "react-dom":
/*!**************************************************************!*\
  !*** external "__Font_Awesome_Webpack_Externals__.ReactDOM" ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = __Font_Awesome_Webpack_Externals__.ReactDOM;
