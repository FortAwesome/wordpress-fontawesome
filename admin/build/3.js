(window["webpackJsonp_font_awesome_admin"] = window["webpackJsonp_font_awesome_admin"] || []).push([[3],{

/***/ "./node_modules/@fortawesome/fa-icon-chooser/dist/esm/utils-dd78e4a8.js":
/*!******************************************************************************!*\
  !*** ./node_modules/@fortawesome/fa-icon-chooser/dist/esm/utils-dd78e4a8.js ***!
  \******************************************************************************/
/*! exports provided: C, F, P, S, b, c, d, f, i, k, l, p */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(global, process) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "C", function() { return CONSOLE_MESSAGE_PREFIX; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "F", function() { return Fragment; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "P", function() { return PREFIX_TO_STYLE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "S", function() { return STYLE_TO_PREFIX; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return buildIconChooserResult; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return createFontAwesomeScriptElement; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return defaultIcons; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return freeCdnBaseUrl; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return isValidSemver; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return kitAssetsBaseUrl; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return lodash; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "p", function() { return parseSvgText; });
var commonjsGlobal=typeof globalThis!=='undefined'?globalThis:typeof window!=='undefined'?window:typeof global!=='undefined'?global:typeof self!=='undefined'?self:{};function getDefaultExportFromCjs(x){return x&&x.__esModule&&Object.prototype.hasOwnProperty.call(x,'default')?x['default']:x;}function createCommonjsModule(fn,basedir,module){return module={path:basedir,exports:{},require:function(path,base){return commonjsRequire(path,base===undefined||base===null?module.path:base);}},fn(module,module.exports),module.exports;}function getDefaultExportFromNamespaceIfPresent(n){return n&&Object.prototype.hasOwnProperty.call(n,'default')?n['default']:n;}function getDefaultExportFromNamespaceIfNotNamed(n){return n&&Object.prototype.hasOwnProperty.call(n,'default')&&Object.keys(n).length===1?n['default']:n;}function getAugmentedNamespace(n){if(n.__esModule)return n;var a=Object.defineProperty({},'__esModule',{value:true});Object.keys(n).forEach(function(k){var d=Object.getOwnPropertyDescriptor(n,k);Object.defineProperty(a,k,d.get?d:{enumerable:true,get:function(){return n[k];}});});return a;}function commonjsRequire(){throw new Error('Dynamic requires are not currently supported by @rollup/plugin-commonjs');}var lodash=createCommonjsModule(function(module,exports){/**
 * @license
...
if(typeof undefined$1=='function'&&typeof undefined$1.amd=='object'&&undefined$1.amd){// Expose Lodash on the global object to prevent errors when Lodash is
// loaded by a script tag in the presence of an AMD loader.
// See http://requirejs.org/docs/errors.html#mismatch for more details.
// Use `_.noConflict` to remove Lodash from the global object.
root._=_;// Define as an anonymous module so, through path mapping, it can be
// referenced as the "underscore" module.
undefined$1(function(){return _;});}// Check for `exports` after `define` in case a build optimizer adds it.
else if(freeModule){// Export for Node.js.
(freeModule.exports=_)._=_;// Export for CommonJS support.
freeExports._=_;}else{// Export to the global object.
root._=_;}}).call(commonjsGlobal);});const data={search:[{id:"user",label:"User",membership:{free:["solid","regular"],pro:["solid","regular","light","thin","duotone"]}},{id:"facebook",label:"Facebook",membership:{free:["brands"],pro:["brands"]}},{id:"check",label:"Check",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"phone",label:"Phone",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"plus",label:"plus",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"twitter",label:"Twitter",membership:{free:["brands"],pro:["brands"]}},{id:"user-secret",label:"User Secret",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"info",label:"Info",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"list",label:"List",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"star",label:"Star",membership:{free:["solid","regular"],pro:["solid","regular","light","thin","duotone"]}},{id:"cart-plus",label:"Add to Shopping Cart",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"book",label:"book",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"heart",label:"Heart",membership:{free:["solid","regular"],pro:["solid","regular","light","thin","duotone"]}},{id:"calendar",label:"Calendar",membership:{free:["solid","regular"],pro:["solid","regular","light","thin","duotone"]}},{id:"trash",label:"Trash",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"download",label:"Download",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"youtube",label:"YouTube",membership:{free:["brands"],pro:["brands"]}},{id:"cross",label:"Cross",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"meteor",label:"Meteor",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"linkedin",label:"LinkedIn",membership:{free:["brands"],pro:["brands"]}},{id:"play",label:"play",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"lock",label:"lock",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"car-building",label:"Car and Building",membership:{free:[],pro:["solid","regular","light","thin","duotone"]}},{id:"question",label:"Question",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"google",label:"Google Logo",membership:{free:["brands"],pro:["brands"]}},{id:"video",label:"Video",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"paper-plane",label:"Paper Plane",membership:{free:["solid","regular"],pro:["solid","regular","light","thin","duotone"]}},{id:"street-view",label:"Street View",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"share",label:"Share",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"code",label:"Code",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"house",label:"House",membership:{free:[],pro:["solid","regular","light","thin","duotone"]}},{id:"bell",label:"bell",membership:{free:["solid","regular"],pro:["solid","regular","light","thin","duotone"]}},{id:"coffee",label:"Coffee",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"computer-speaker",label:"Computer Speaker",membership:{free:[],pro:["solid","regular","light","thin","duotone"]}},{id:"bars",label:"Bars",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"github",label:"GitHub",membership:{free:["brands"],pro:["brands"]}},{id:"comment",label:"comment",membership:{free:["solid","regular"],pro:["solid","regular","light","thin","duotone"]}},{id:"image",label:"Image",membership:{free:["solid","regular"],pro:["solid","regular","light","thin","duotone"]}},{id:"folder",label:"Folder",membership:{free:["solid","regular"],pro:["solid","regular","light","thin","duotone"]}},{id:"key",label:"key",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"mobile",label:"Mobile Phone",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"camera",label:"camera",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"text",label:"Text",membership:{free:[],pro:["solid","regular","light","thin","duotone"]}},{id:"umbrella-beach",label:"Umbrella Beach",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"building",label:"Building",membership:{free:["solid","regular"],pro:["solid","regular","light","thin","duotone"]}},{id:"print",label:"print",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"sort",label:"Sort",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"flag",label:"flag",membership:{free:["solid","regular"],pro:["solid","regular","light","thin","duotone"]}},{id:"network-wired",label:"Wired Network",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"pencil",label:"pencil",membership:{free:[],pro:["solid","regular","light","thin","duotone"]}},{id:"quote-right",label:"quote-right",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"truck",label:"truck",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"pepper-hot",label:"Pepper Hot",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"file-export",label:"File Export",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"table",label:"table",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"file-invoice",label:"File Invoice",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"moon-stars",label:"Moon with Stars",membership:{free:[],pro:["solid","regular","light","thin","duotone"]}},{id:"tty",label:"TTY",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"registered",label:"Registered Trademark",membership:{free:["solid","regular"],pro:["solid","regular","light","thin","duotone"]}},{id:"phone-office",label:"Office Phone",membership:{free:[],pro:["solid","regular","light","thin","duotone"]}},{id:"video-slash",label:"Video Slash",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"person-dolly-empty",label:"Person and Empty Dolly",membership:{free:[],pro:["solid","regular","light","thin","duotone"]}},{id:"signature",label:"Signature",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"store",label:"Store",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"projector",label:"Projector",membership:{free:[],pro:["solid","regular","light","thin","duotone"]}},{id:"loveseat",label:"Loveseat",membership:{free:[],pro:["solid","regular","light","thin","duotone"]}},{id:"arrow-right",label:"arrow-right",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"music",label:"Music",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"icons",label:"Icons",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"power-off",label:"Power Off",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"wifi",label:"WiFi",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"vials",label:"Vials",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"door-open",label:"Door Open",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"shield-check",label:"shield",membership:{free:[],pro:["solid","regular","light","thin","duotone"]}},{id:"line-height",label:"Line Height",membership:{free:[],pro:["solid","regular","light","thin","duotone"]}},{id:"expand",label:"Expand",membership:{free:["solid"],pro:["solid","regular","light","thin","duotone"]}},{id:"walkie-talkie",label:"Walkie Talkie",membership:{free:[],pro:["solid","regular","light","thin","duotone"]}},{id:"mailbox",label:"Mailbox",membership:{free:[],pro:["solid","regular","light","thin","duotone"]}}]};const defaultIconsSearchResult={data:data};var semver=createCommonjsModule(function(module,exports){exports=module.exports=SemVer;var debug;/* istanbul ignore next */if(typeof process==='object'&&process.env&&process.env.NODE_DEBUG&&/\bsemver\b/i.test(process.env.NODE_DEBUG)){debug=function(){var args=Array.prototype.slice.call(arguments,0);args.unshift('SEMVER');console.log.apply(console,args);};}else{debug=function(){};}// Note: this is the semver.org version of the spec that it implements
...
var re=exports.re=[];var src=exports.src=[];var t=exports.tokens={};var R=0;function tok(n){t[n]=R++;}// The following Regular Expressions can be used for tokenizing,
// validating, and parsing SemVer version strings.
// ## Numeric Identifier
// A single `0`, or a non-zero digit followed by zero or more digits.
tok('NUMERICIDENTIFIER');src[t.NUMERICIDENTIFIER]='0|[1-9]\\d*';tok('NUMERICIDENTIFIERLOOSE');src[t.NUMERICIDENTIFIERLOOSE]='[0-9]+';// ## Non-numeric Identifier
// Zero or more digits, followed by a letter or hyphen, and then zero or
// more letters, digits, or hyphens.
tok('NONNUMERICIDENTIFIER');src[t.NONNUMERICIDENTIFIER]='\\d*[a-zA-Z-][a-zA-Z0-9-]*';// ## Main Version
// Three dot-separated numeric identifiers.
tok('MAINVERSION');src[t.MAINVERSION]='('+src[t.NUMERICIDENTIFIER]+')\\.'+'('+src[t.NUMERICIDENTIFIER]+')\\.'+'('+src[t.NUMERICIDENTIFIER]+')';tok('MAINVERSIONLOOSE');src[t.MAINVERSIONLOOSE]='('+src[t.NUMERICIDENTIFIERLOOSE]+')\\.'+'('+src[t.NUMERICIDENTIFIERLOOSE]+')\\.'+'('+src[t.NUMERICIDENTIFIERLOOSE]+')';// ## Pre-release Version Identifier
// A numeric identifier, or a non-numeric identifier.
tok('PRERELEASEIDENTIFIER');src[t.PRERELEASEIDENTIFIER]='(?:'+src[t.NUMERICIDENTIFIER]+'|'+src[t.NONNUMERICIDENTIFIER]+')';tok('PRERELEASEIDENTIFIERLOOSE');src[t.PRERELEASEIDENTIFIERLOOSE]='(?:'+src[t.NUMERICIDENTIFIERLOOSE]+'|'+src[t.NONNUMERICIDENTIFIER]+')';// ## Pre-release Version
// Hyphen, followed by one or more dot-separated pre-release version
// identifiers.
tok('PRERELEASE');src[t.PRERELEASE]='(?:-('+src[t.PRERELEASEIDENTIFIER]+'(?:\\.'+src[t.PRERELEASEIDENTIFIER]+')*))';tok('PRERELEASELOOSE');src[t.PRERELEASELOOSE]='(?:-?('+src[t.PRERELEASEIDENTIFIERLOOSE]+'(?:\\.'+src[t.PRERELEASEIDENTIFIERLOOSE]+')*))';// ## Build Metadata Identifier
// Any combination of digits, letters, or hyphens.
tok('BUILDIDENTIFIER');src[t.BUILDIDENTIFIER]='[0-9A-Za-z-]+';// ## Build Metadata
// Plus sign, followed by one or more period-separated build metadata
// identifiers.
tok('BUILD');src[t.BUILD]='(?:\\+('+src[t.BUILDIDENTIFIER]+'(?:\\.'+src[t.BUILDIDENTIFIER]+')*))';// ## Full Version String
...
// comparison.
tok('FULL');tok('FULLPLAIN');src[t.FULLPLAIN]='v?'+src[t.MAINVERSION]+src[t.PRERELEASE]+'?'+src[t.BUILD]+'?';src[t.FULL]='^'+src[t.FULLPLAIN]+'$';// like full, but allows v1.2.3 and =1.2.3, which people do sometimes.
// also, 1.0.0alpha1 (prerelease without the hyphen) which is pretty
// common in the npm registry.
tok('LOOSEPLAIN');src[t.LOOSEPLAIN]='[v=\\s]*'+src[t.MAINVERSIONLOOSE]+src[t.PRERELEASELOOSE]+'?'+src[t.BUILD]+'?';tok('LOOSE');src[t.LOOSE]='^'+src[t.LOOSEPLAIN]+'$';tok('GTLT');src[t.GTLT]='((?:<|>)?=?)';// Something like "2.*" or "1.2.x".
// Note that "x.x" is a valid xRange identifer, meaning "any version"
// Only the first item is strictly required.
tok('XRANGEIDENTIFIERLOOSE');src[t.XRANGEIDENTIFIERLOOSE]=src[t.NUMERICIDENTIFIERLOOSE]+'|x|X|\\*';tok('XRANGEIDENTIFIER');src[t.XRANGEIDENTIFIER]=src[t.NUMERICIDENTIFIER]+'|x|X|\\*';tok('XRANGEPLAIN');src[t.XRANGEPLAIN]='[v=\\s]*('+src[t.XRANGEIDENTIFIER]+')'+'(?:\\.('+src[t.XRANGEIDENTIFIER]+')'+'(?:\\.('+src[t.XRANGEIDENTIFIER]+')'+'(?:'+src[t.PRERELEASE]+')?'+src[t.BUILD]+'?'+')?)?';tok('XRANGEPLAINLOOSE');src[t.XRANGEPLAINLOOSE]='[v=\\s]*('+src[t.XRANGEIDENTIFIERLOOSE]+')'+'(?:\\.('+src[t.XRANGEIDENTIFIERLOOSE]+')'+'(?:\\.('+src[t.XRANGEIDENTIFIERLOOSE]+')'+'(?:'+src[t.PRERELEASELOOSE]+')?'+src[t.BUILD]+'?'+')?)?';tok('XRANGE');src[t.XRANGE]='^'+src[t.GTLT]+'\\s*'+src[t.XRANGEPLAIN]+'$';tok('XRANGELOOSE');src[t.XRANGELOOSE]='^'+src[t.GTLT]+'\\s*'+src[t.XRANGEPLAINLOOSE]+'$';// Coercion.
// Extract anything that could conceivably be a part of a valid semver
tok('COERCE');src[t.COERCE]='(^|[^\\d])'+'(\\d{1,'+MAX_SAFE_COMPONENT_LENGTH+'})'+'(?:\\.(\\d{1,'+MAX_SAFE_COMPONENT_LENGTH+'}))?'+'(?:\\.(\\d{1,'+MAX_SAFE_COMPONENT_LENGTH+'}))?'+'(?:$|[^\\d])';tok('COERCERTL');re[t.COERCERTL]=new RegExp(src[t.COERCE],'g');// Tilde ranges.
// Meaning is "reasonably at or greater than"
tok('LONETILDE');src[t.LONETILDE]='(?:~>?)';tok('TILDETRIM');src[t.TILDETRIM]='(\\s*)'+src[t.LONETILDE]+'\\s+';re[t.TILDETRIM]=new RegExp(src[t.TILDETRIM],'g');var tildeTrimReplace='$1~';tok('TILDE');src[t.TILDE]='^'+src[t.LONETILDE]+src[t.XRANGEPLAIN]+'$';tok('TILDELOOSE');src[t.TILDELOOSE]='^'+src[t.LONETILDE]+src[t.XRANGEPLAINLOOSE]+'$';// Caret ranges.
// Meaning is "at least and backwards compatible with"
tok('LONECARET');src[t.LONECARET]='(?:\\^)';tok('CARETTRIM');src[t.CARETTRIM]='(\\s*)'+src[t.LONECARET]+'\\s+';re[t.CARETTRIM]=new RegExp(src[t.CARETTRIM],'g');var caretTrimReplace='$1^';tok('CARET');src[t.CARET]='^'+src[t.LONECARET]+src[t.XRANGEPLAIN]+'$';tok('CARETLOOSE');src[t.CARETLOOSE]='^'+src[t.LONECARET]+src[t.XRANGEPLAINLOOSE]+'$';// A simple gt/lt/eq thing, or just "" to indicate "any version"
tok('COMPARATORLOOSE');src[t.COMPARATORLOOSE]='^'+src[t.GTLT]+'\\s*('+src[t.LOOSEPLAIN]+')$|^$';tok('COMPARATOR');src[t.COMPARATOR]='^'+src[t.GTLT]+'\\s*('+src[t.FULLPLAIN]+')$|^$';// An expression to strip any whitespace between the gtlt and the thing
// it modifies, so that `> 1.2.3` ==> `>1.2.3`
tok('COMPARATORTRIM');src[t.COMPARATORTRIM]='(\\s*)'+src[t.GTLT]+'\\s*('+src[t.LOOSEPLAIN]+'|'+src[t.XRANGEPLAIN]+')';// this one has to use the /g flag
re[t.COMPARATORTRIM]=new RegExp(src[t.COMPARATORTRIM],'g');var comparatorTrimReplace='$1$2$3';// Something like `1.2.3 - 1.2.4`
// Note that these all use the loose form, because they'll be
// checked against either the strict or loose comparator form
// later.
tok('HYPHENRANGE');src[t.HYPHENRANGE]='^\\s*('+src[t.XRANGEPLAIN]+')'+'\\s+-\\s+'+'('+src[t.XRANGEPLAIN]+')'+'\\s*$';tok('HYPHENRANGELOOSE');src[t.HYPHENRANGELOOSE]='^\\s*('+src[t.XRANGEPLAINLOOSE]+')'+'\\s+-\\s+'+'('+src[t.XRANGEPLAINLOOSE]+')'+'\\s*$';// Star ranges basically just allow anything at all.
tok('STAR');src[t.STAR]='(<|>)?=?\\s*\\*';// Compile to actual regexp objects.
// All are flag-free, unless they were created above with a flag.
for(var i=0;i<R;i++){debug(i,src[i]);if(!re[i]){re[i]=new RegExp(src[i]);}}exports.parse=parse;function parse(version,options){if(!options||typeof options!=='object'){options={loose:!!options,includePrerelease:false};}if(version instanceof SemVer){return version;}if(typeof version!=='string'){return null;}if(version.length>MAX_LENGTH){return null;}var r=options.loose?re[t.LOOSE]:re[t.FULL];if(!r.test(version)){return null;}try{return new SemVer(version,options);}catch(er){return null;}}exports.valid=valid;function valid(version,options){var v=parse(version,options);return v?v.version:null;}exports.clean=clean;function clean(version,options){var s=parse(version.trim().replace(/^[=v]+/,''),options);return s?s.version:null;}exports.SemVer=SemVer;function SemVer(version,options){if(!options||typeof options!=='object'){options={loose:!!options,includePrerelease:false};}if(version instanceof SemVer){if(version.loose===options.loose){return version;}else{version=version.version;}}else if(typeof version!=='string'){throw new TypeError('Invalid Version: '+version);}if(version.length>MAX_LENGTH){throw new TypeError('version is longer than '+MAX_LENGTH+' characters');}if(!(this instanceof SemVer)){return new SemVer(version,options);}debug('SemVer',version,options);this.options=options;this.loose=!!options.loose;var m=version.trim().match(options.loose?re[t.LOOSE]:re[t.FULL]);if(!m){throw new TypeError('Invalid Version: '+version);}this.raw=version;// these are actually numbers
...
return c.length;});if(!this.set.length){throw new TypeError('Invalid SemVer Range: '+range);}this.format();}Range.prototype.format=function(){this.range=this.set.map(function(comps){return comps.join(' ').trim();}).join('||').trim();return this.range;};Range.prototype.toString=function(){return this.range;};Range.prototype.parseRange=function(range){var loose=this.options.loose;range=range.trim();// `1.2.3 - 1.2.4` => `>=1.2.3 <=1.2.4`
var hr=loose?re[t.HYPHENRANGELOOSE]:re[t.HYPHENRANGE];range=range.replace(hr,hyphenReplace);debug('hyphen replace',range);// `> 1.2.3 < 1.2.5` => `>1.2.3 <1.2.5`
...
var compRe=loose?re[t.COMPARATORLOOSE]:re[t.COMPARATOR];var set=range.split(' ').map(function(comp){return parseComparator(comp,this.options);},this).join(' ').split(/\s+/);if(this.options.loose){// in loose mode, throw out any that are not valid comparators
set=set.filter(function(comp){return!!comp.match(compRe);});}set=set.map(function(comp){return new Comparator(comp,this.options);},this);return set;};Range.prototype.intersects=function(range,options){if(!(range instanceof Range)){throw new TypeError('a Range is required');}return this.set.some(function(thisComparators){return isSatisfiable(thisComparators,options)&&range.set.some(function(rangeComparators){return isSatisfiable(rangeComparators,options)&&thisComparators.every(function(thisComparator){return rangeComparators.every(function(rangeComparator){return thisComparator.intersects(rangeComparator,options);});});});});};// take a set of comparators and determine whether there
// exists a version which can satisfy it
function isSatisfiable(comparators,options){var result=true;var remainingComparators=comparators.slice();var testComparator=remainingComparators.pop();while(result&&remainingComparators.length){result=remainingComparators.every(function(otherComparator){return testComparator.intersects(otherComparator,options);});testComparator=remainingComparators.pop();}return result;}// Mostly just for testing and legacy API reasons
...
function replaceTildes(comp,options){return comp.trim().split(/\s+/).map(function(comp){return replaceTilde(comp,options);}).join(' ');}function replaceTilde(comp,options){var r=options.loose?re[t.TILDELOOSE]:re[t.TILDE];return comp.replace(r,function(_,M,m,p,pr){debug('tilde',comp,_,M,m,p,pr);var ret;if(isX(M)){ret='';}else if(isX(m)){ret='>='+M+'.0.0 <'+(+M+1)+'.0.0';}else if(isX(p)){// ~1.2 == >=1.2.0 <1.3.0
...
gtlt='<';if(xm){M=+M+1;}else{m=+m+1;}}ret=gtlt+M+'.'+m+'.'+p+pr;}else if(xm){ret='>='+M+'.0.0'+pr+' <'+(+M+1)+'.0.0'+pr;}else if(xp){ret='>='+M+'.'+m+'.0'+pr+' <'+M+'.'+(+m+1)+'.0'+pr;}debug('xRange return',ret);return ret;});}// Because * is AND-ed with everything else in the comparator,
...
return comp.trim().replace(re[t.STAR],'');}// This function is passed to string.replace(re[t.HYPHENRANGE])
...
Range.prototype.test=function(version){if(!version){return false;}if(typeof version==='string'){try{version=new SemVer(version,this.options);}catch(er){return false;}}for(var i=0;i<this.set.length;i++){if(testSet(this.set[i],version,this.options)){return true;}}return false;};function testSet(set,version,options){for(var i=0;i<set.length;i++){if(!set[i].test(version)){return false;}}if(version.prerelease.length&&!options.includePrerelease){// Find the set of versions that are allowed to have prereleases
...
if((!low.operator||low.operator===comp)&&ltefn(version,low.semver)){return false;}else if(low.operator===ecomp&&ltfn(version,low.semver)){return false;}}return true;}exports.prerelease=prerelease;function prerelease(version,options){var parsed=parse(version,options);return parsed&&parsed.prerelease.length?parsed.prerelease:null;}exports.intersects=intersects;function intersects(r1,r2,options){r1=new Range(r1,options);r2=new Range(r2,options);return r1.intersects(r2);}exports.coerce=coerce;function coerce(version,options){if(version instanceof SemVer){return version;}if(typeof version==='number'){version=String(version);}if(typeof version!=='string'){return null;}options=options||{};var match=null;if(!options.rtl){match=version.match(re[t.COERCE]);}else{// Find the right-most coercible string that does not share
...
re[t.COERCERTL].lastIndex=-1;}if(match===null){return null;}return parse(match[2]+'.'+(match[3]||'0')+'.'+(match[4]||'0'),options);}});const defaultIcons=defaultIconsSearchResult;const STYLE_TO_PREFIX={solid:'fas',duotone:'fad',regular:'far',light:'fal',thin:'fat',kit:'fak',brands:'fab'};const PREFIX_TO_STYLE={fas:'solid',fad:'duotone',far:'regular',fal:'light',fat:'thin',fak:'kit',fab:'brands'};// TODO: do we want to include this code in this project?
const viewBoxRe=/viewBox="0 0 ([0-9]+) ([0-9]+)"/;const singlePathRe=/path d="([^"]+)"/;const duotonePathDuoClasslessRe=/path d="([^"]+)".*path d="([^"]+)"/;const duotonePathDuoClassedRe=/path class="([^"]+)".*d="([^"]+)".*path class="([^"]+)".*d="([^"]+)"/;const duotonePathOnlyPrimaryRe=/path class="(fa-primary)".*d="([^"]+)"/;const duotonePathOnlySecondaryRe=/path class="(fa-secondary)".*d="([^"]+)"/;const CONSOLE_MESSAGE_PREFIX='Font Awesome Icon Chooser';function parseSvgText(svgText){let val=null;let path=null;const viewBox=svgText.match(viewBoxRe);const singlePath=svgText.match(singlePathRe);const duotonePath=svgText.match(duotonePathDuoClasslessRe)||svgText.match(duotonePathDuoClassedRe)||svgText.match(duotonePathOnlyPrimaryRe)||svgText.match(duotonePathOnlySecondaryRe);if(duotonePath&&duotonePath.length===3){if(duotonePath[1].indexOf('primary')>-1){path=[duotonePath[2],''];}else if(duotonePath[1].indexOf('secondary')>-1){path=['',duotonePath[2]];}else{path=[duotonePath[1],duotonePath[2]];}}else if(duotonePath&&duotonePath.length===5){path=duotonePath[1].indexOf('primary')>-1?[duotonePath[2],duotonePath[4]]:[duotonePath[4],duotonePath[2]];}else if(singlePath){path=singlePath[1];}if(viewBox&&path){val=[parseInt(viewBox[1],10),parseInt(viewBox[2],10),[],null,path];}return val;}function freeCdnBaseUrl(){return'https://use.fontawesome.com';}function kitAssetsBaseUrl(pro){return pro?'https://ka-p.fontawesome.com':'https://ka-f.fontawesome.com';}async function createFontAwesomeScriptElement(getUrlText,pro,version,baseUrl,kitToken){const license=pro?'pro':'free';const assetUrl=kitToken?`${baseUrl}/releases/v${version}/js/${license}.min.js?token=${kitToken}`:`${baseUrl}/releases/v${version}/js/all.js`;try{if('function'!==typeof getUrlText)throw new Error("Font Awesome Icon Chooser: expected getUrlText to be a function but it wasn't");const scriptContent=await getUrlText(assetUrl);const script=document.createElement('SCRIPT');const text=document.createTextNode(scriptContent);script.appendChild(text);script.setAttribute('data-auto-replace-svg','false');script.setAttribute('data-auto-add-css','false');script.setAttribute('type','text/javascript');return script;}catch(e){console.error(e);throw new Error(e);}}function buildIconChooserResult(iconLookup){const{prefix,iconName}=iconLookup;return{prefix,iconName};}function isValidSemver(val){return!!semver.valid(val);}const Fragment=(_props,children)=>[...children];
