...
export function setupBlockEditor(params) {
  ...
  /*
  const {
    metadata: iconBlockMetadata,
    save: iconBlockSave,
    createEditComponent: iconBlockCreateEditComponent,
    Edit,
  } = window.__FontAwesomeOfficialPlugin__icon_block || {};
  console.log("EDIT", Edit);
  console.log("createEditComponent", iconBlockCreateEditComponent);
  console.log("blockMeta", iconBlockMetadata);
  console.log("icon", toolbarIcon);

  registerBlockType(iconBlockMetadata.name, {
    icon: toolbarIcon,
    title: "Font Awesome Icon",
    //edit: iconBlockCreateEditComponent(params),
    //edit: Edit,
    //save: iconBlockSave,
  });
  */
