...
class ConfigControllerTest extends \WP_UnitTestCase {
	...
	protected function prepare( $responses ) {
		...
		$controllerMock = $this->getMockBuilder(FontAwesome_Config_Controller::class)
					->setConstructorArgs([ FontAwesome::PLUGIN_NAME, FontAwesome::REST_API_NAMESPACE  ])
					->setMethods( [ 'release_provider' ] )
		            ->getMock();
