...
function fa_kses_allow_path_fill_callback($value) {
	// See: https://developer.mozilla.org/en-US/docs/Web/SVG/Content_type#paint
    // paint ::= none | <color> | <url> [none | <color>]? | context-fill | context-stroke

	// For now, we'll be super-strict by allowing only one value.
...
add_filter(
	...
	function($tags, $context) {
		...
		$path = array(
			...
			"fill" => array(
				'required' => false,
				'value_callback' => 'FortAwesome\fa_kses_allow_path_fill_callback'
			)
		);
