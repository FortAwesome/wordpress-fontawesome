...
In that case, then you might prefer to do a [custom installation](https://fontawesome.com/v6.0/docs/web/use-with/wordpress) _instead_ of using this plugin package.
